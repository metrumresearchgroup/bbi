...
const (
	...
	Model_ERROR     Model_StatusType = 3
)
...
type ModelInfo_RunSettings struct {
	...
	OneEst             bool   `protobuf:"varint,10,opt,name=one_est,json=oneEst,proto3" json:"one_est,omitempty"`
	ProposedRunDir     string `protobuf:"bytes,11,opt,name=proposed_run_dir,json=proposedRunDir,proto3" json:"proposed_run_dir,omitempty"`
}
...
func (m *ModelInfo_RunSettings) GetOneEst() bool {
	if m != nil {
		return m.OneEst
	}
	return false
...
func (m *ModelInfo_RunSettings) GetProposedRunDir() string {
	if m != nil {
		return m.ProposedRunDir
	}
	return ""
}
...
func (m *RunInfo) GetDuration() float64 {
	if m != nil {
		return m.Duration
	}
	return 0
...
func (m *ModelInfo_RunSettings) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.ProposedRunDir) > 0 {
		dAtA[i] = 0x5a
		i++
		i = encodeVarintInternal(dAtA, i, uint64(len(m.ProposedRunDir)))
		i += copy(dAtA[i:], m.ProposedRunDir)
	}
	return i, nil
}
...
func (m *ModelInfo_RunSettings) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field OneEst", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ProposedRunDir", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ProposedRunDir = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipInternal(dAtA[iNdEx:])
...
var fileDescriptorInternal = []byte{
	...
	,
}
