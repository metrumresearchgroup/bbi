...
type gridSpec struct {
	...
	//
	//  * Command ([]string): a slice defining the program and all arguments of
	//    the command to execute.  These values should be rendered to the final
	//    command string.
	//
	...
	//    executed
	//
	//  The template is responsible for quoting any values as needed.
	Template string
