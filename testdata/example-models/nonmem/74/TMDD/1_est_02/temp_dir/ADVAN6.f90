...
! LOGICAL
      USE PRCOM_LOG,    ONLY: DTIME,LFLAG,DTDER,NOETAS2=>NOETAS,SECOND
...
!
      IF (ICALL /= 2) THEN
        IF (ICALL == 0) THEN    ! Initialization call    .  Changed for nonmemn7.4 to use tolprocess
...
! Exit point 
      ...
      END IF
!
  125 FORMAT (' GENERAL NONLINEAR KINETICS MODEL (DVERK1, ADVAN6)')
!
  999 RETURN
!
